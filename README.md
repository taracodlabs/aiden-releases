# Aiden — Installer Releases

Pre-built installers for [Aiden](https://aiden.taracod.com) — a local-first AI OS for Windows. 56 skills, 60+ tools, 13 providers, fully open source under AGPL-3.0.
...
**Manual installer:** download the latest `.exe` from [Releases](https://github.com/taracodlabs/aiden-releases/releases/latest), run it, and launch Aiden via Start menu or `aiden pc`.
...
See the [Releases page](https://github.com/taracodlabs/aiden-releases/releases) for version history and direct download links.

Current: **v3.7.0** — first open source release.

## System requirements

- Windows 10 or 11 (64-bit)
- ~2 GB free disk space
- Internet connection for first-run setup and optional cloud providers
- Optional: NVIDIA GPU with 6+ GB VRAM for local model acceleration (GTX 1060 and above)
...
Installers distributed under the Aiden software license:
- **Core:** AGPL-3.0-only
- **Skills:** Apache-2.0

Commercial use: [contact@taracod.com](mailto:contact@taracod.com)
